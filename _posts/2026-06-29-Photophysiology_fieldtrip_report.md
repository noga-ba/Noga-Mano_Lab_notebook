...
*$$F_0$$* - Minimum Fluorescence: Baseline fluorescence when all reaction centers are open in the dark

*$$F_m$$* - Maximum Fluorescence: Peak fluorescence achieved when a short, intense saturating light pulse temporarily closes all reaction centers

*$$F_v$$* - Variable Fluorescence: The dynamic range of fluorescence (*Fm-F0*)
